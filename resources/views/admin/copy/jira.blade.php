...
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            <h1>Copywriter Ticket Status Board</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></div>
                <div class="breadcrumb-item">Copywriter Ticket Status Board</div>
            </div>
        </div>

        <div class="section-body">

            @include('admin.copy._filter')
            ...
            <div class="row flex-nowrap" style="overflow-x: scroll; padding-top: 17px;">
                ...
                <div class="col-md-3">
                    ...
                    @foreach ($copy_requested_list as $copy)

                            <div class="card">
                                <a href="{{ url('admin/copy/'. $copy->copy_id .'/edit')}}" style="text-decoration: none;">
...
{{--                                                            data-original-title="{{ $copy->assign_to }}"--}}
{{--                                                            data-initial="{{ substr($copy->assign_to, 0, 1) }}">--}}
{{--                                                    </figure>--}}
{{--                                                </div>--}}
                                                <div style="float: right;">
                                                    <figure class="avatar mr-2 avatar-sm text-white" style="background-color: #b6b6b6; font-size: 15px;"
                                                            data-toggle="tooltip" data-placement="top"
                                                            data-original-title="{{ $copy->request_by }}"
                                                            data-initial="{{ substr($copy->request_by, 0, 1) }}">
                                                    </figure>
                                                </div>
                                                <div class="media-title" style="clear:both; font-size: large;">
                                                    {{ mb_strimwidth($copy->title, 0,50, '...') }}
                                                </div>
...
{{--                                                </div>--}}
                                                ...
                                                <?php if($copy->priority == 'Critical') {
                                                    $bg_type = '#FF0000';
                                                }else if($copy->priority == 'High'){
                                                    $bg_type = '#FFA500';
                                                }else{
                                                    $bg_type = '#008000';
                                                }
                ...
                <div class="col-md-3">
                    ...
                    @foreach ($copy_to_do_list as $copy)
                ...
                <div class="col-md-3">
                    ...
                    @foreach ($copy_in_progress_list as $copy)
                ...
                <div class="col-md-3">
                    ...
                    @foreach ($copy_review_list as $copy)
                ...
                <div class="col-md-3">
                    <div class="card status_title">
                        <h5 class="status_name">COPY COMPLETED</h5>
                    </div>

                    @foreach ($copy_done_list as $copy)
