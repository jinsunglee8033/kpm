...
<form method="POST" action="{{ route('campaign.edit_programmatic_banners', $asset_id) }}" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="date_from" id="{{$asset_id}}_date_from" placeholder="Start date" autocomplete="off"
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label>Run To: </label>
                <input type="text" name="date_to" id="date_to" placeholder="End date" autocomplete="off"
    ...
    <?php $copy_start = date('F j, Y', strtotime($data[0][0]->date_from . ' -' . $step_3 . ' weekday')); ?>
    <?php $creative_start = date('F j, Y', strtotime($data[0][0]->date_from . ' -' . $step_4 . ' weekday')); ?>
