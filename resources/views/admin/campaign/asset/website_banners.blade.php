...
<form method="POST" action="{{ route('campaign.edit_website_banners', $asset_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group checkboxes">
        ...
        <?php $checkbox_fields = explode(', ', $data[0][0]->banner); ?>
    ...
    <div class="form-group">
        <label>Details:</label>
        <textarea class="form-control" id="details" name="details" rows="5" cols="100" style="height: 150px;"><?php echo $data[0][0]->details; ?></textarea>
    </div>
...
<script type="text/javascript">
    // Lead time +29 days - Website Banners
    $(function() {
