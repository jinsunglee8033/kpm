...
<form method="POST" action="{{ route('campaign.edit_image_request', $asset_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="text" name="image_dimensions" class="form-control" value="<?php echo $data[0][0]->image_dimensions; ?>">
    </div>

    <div class="form-group">
        <label>Image Ratio:</label>
        <input type="text" name="image_ratio" class="form-control" value="<?php echo $data[0][0]->image_ratio; ?>">
    </div>

    <div class="form-group">
        <label>Image Format:</label>
        <input type="text" name="image_format" class="form-control" value="<?php echo $data[0][0]->image_format; ?>">
    </div>

    <div class="form-group">
        <label>Max Filesize:</label>
        <input type="text" name="max_filesize" class="form-control" value="<?php echo $data[0][0]->max_filesize; ?>">
    </div>

    <div class="form-group">
        <label>SKU:</label>
        <input type="text" name="sku" class="form-control" value="<?php echo $data[0][0]->sku; ?>">
    </div>
    ...
    <div class="form-group">
        ...
        {!! Form::textarea('description', !empty($data[0][0]) ? $data[0][0]->description : null, ['class' => 'form-control summernote']) !!}
    </div>
...
<script type="text/javascript">
    // Lead time +14 days - Image Request
    $(function() {
