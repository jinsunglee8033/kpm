...
<div class="card" style="background-color: #f5f6fe; margin-bottom: 3px; margin-top: 20px;">
...
<form method="POST" action="{{ route('campaign.edit_email_blast', $asset_id) }}" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label>Email Blast Date:</label>
            <input type="text" name="email_blast_date" id="{{$asset_id}}_email_blast_date" autocomplete="off"
    ...
    <?php $copy_start = date('F j, Y', strtotime($data[0][0]->email_blast_date . ' -' . $step_3 . ' weekday')); ?>
    <?php $creative_start = date('F j, Y', strtotime($data[0][0]->email_blast_date . ' -' . $step_4 . ' weekday')); ?>
    ...
    <div class="form-group">
        <table class="reminder_table">
            ...
            <tr>
                ...
                <td style="color: #b91d19"><span><b><?php echo date('m/d/Y', strtotime($data[0][0]->email_blast_date . ' -' . $step_1 . ' weekday')); ?></b></span></td>
            </tr>
            <tr>
                <td ><span class="lead-time"><b>&nbspCopy Start&nbsp</b></span></td>
                <td style="color: #b91d19"><span><b><?php echo date('m/d/Y', strtotime($data[0][0]->email_blast_date . ' -' . $step_2 . ' weekday')); ?></b></span></td>
            </tr>
            <tr>
                <td><span class="lead-time"><b>&nbspCopy Review Start&nbsp</b></span></td>
                <td style="color: #b91d19"><span><b><?php echo date('m/d/Y', strtotime($data[0][0]->email_blast_date . ' -' . $step_3 . ' weekday')); ?></b></span></td>
            </tr>
            <?php } ?>
            <tr>
                <td><span class="lead-time"><b>&nbspCreator Assign Start&nbsp</b></span></td>
                <td style="color: #b91d19"><span><b><?php echo date('m/d/Y', strtotime($data[0][0]->email_blast_date . ' -' . $step_4 . ' weekday')); ?></b></span></td>
            </tr>
            <tr>
                <td><span class="lead-time"><b>&nbspCreative Work Start&nbsp</b></span></td>
                <td style="color: #b91d19"><span><b><?php echo date('m/d/Y', strtotime($data[0][0]->email_blast_date . ' -' . $step_5 . ' weekday')); ?></b></span></td>
            </tr>
            <tr>
                <td><span class="lead-time"><b>&nbspCreative Review Start&nbsp</b></span></td>
                <td style="color: #b91d19"><span><b><?php echo date('m/d/Y', strtotime($data[0][0]->email_blast_date . ' -' . $step_6 . ' weekday')); ?></b></span></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="color: #b91d19"><span><b><?php echo date('m/d/Y', strtotime($data[0][0]->email_blast_date . ' -' . $step_8 . ' weekday')); ?></b></span></td>
            </tr>
        </table>
    </div>
