...
<form method="POST" action="{{ route('campaign.edit_misc', $asset_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
        <table class="reminder_table">
            ...
            <tr>
                <td><span class="lead-time"><b>&nbspCopywriters Assign Start&nbsp</b></span></td>
