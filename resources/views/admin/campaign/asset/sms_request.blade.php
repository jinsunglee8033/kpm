...
<form method="POST" action="{{ route('campaign.edit_sms_request', $asset_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
        <label>Title:</label>
        <textarea class="form-control" maxlength="255" name="title" rows="5" cols="100"><?php echo $data[0][0]->title ?></textarea>
    </div>

    <div class="form-group">
        <label>Launch Date:</label>
        <input type="text" name="launch_date" id="{{$asset_id}}_launch_date" autocomplete="off"
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" id="copy" name="copy" style="height:100px;"
                  onkeyup="sms_request_limit(this, {{$asset_id}})"
        ><?php echo $data[0][0]->copy; ?></textarea>
        <p id="{{$asset_id}}_charsLeft"></p>
    </div>

    <div class="form-group">
        <label>Developer Proof:</label>
        <input type="text" name="developer_url" class="form-control" value="<?php echo $data[0][0]->developer_url; ?>">
    </div>
...
<script type="text/javascript">
    ...
    function sms_request_limit(element, asset_id) {
